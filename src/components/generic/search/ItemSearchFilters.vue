<template>
  <div class="item-filters-container">
    ...
    <div class="rule-card q-pa-sm">
      <div
        v-if="!filters?.length"
        class="flex flex-col justify-center items-center q-my-md"
      >
        <div class="text-bold q-ma-sm">
          {{ $t('forms.itemFilters.rules.noRules') }}
        </div>
      </div>
      <div v-else>
        <div class="text-bold q-mb-sm">
          {{ title || $t('forms.itemFilters.rules.title') }}
        </div>
          ...
          >
            <div class="row items-center">
              <div class="text-bold q-mr-sm">
                {{ $t('forms.itemFilters.rules.group') }}
              </div>
              <SelectInput
            ...
            >
              {{ $t('forms.itemFilters.rules.noGroupRules') }}
            </div>
            <div
